    ...
    <div className="app-shell">
      <header className="topbar">
        ...
        <div className="topbar-center">
          ...
          <span className="build-badge">v0.4 · INVITE ADVISORS</span>
        </div>
        ...
        <div className="council-column">
          ...
          <form className="royal-command" onSubmit={submit}>
            <div className="command-heading">
              ...
              <small>
                当前圆桌仍由 deterministic mock council 演示；v0.4 开始建立你自己的本地 Provider 名册。
              </small>
            </div>
            <div className="command-row">
              ...
              />
              <button type="submit" disabled={council.isRunning || question.trim().length === 0}>
          ...
          <HistorianPanel
            ...
            disabled={council.isRunning}
            onOpen={(sessionId) => void openArchive(sessionId)}
          />
        </div>
      ...
      <footer className="app-footer">
        ...
        <span>•</span>
        <span>{providers.profiles.length} local provider profile{providers.profiles.length === 1 ? "" : "s"}</span>
        <span>•</span>
        <span>Round 1 stays sealed</span>
        <span>•</span>
