...
assert(likelyLoginPage({ url: "https://claude.ai/", title: "Log in | Claude" }), "safe tab title should provide a login signal");
...
assert(deriveConnectionExperience({ connectionState: "connecting", recovering: true }) === "recovering", "recovery should stay visible while the automatic connector is running");
