...
const tests = [
  ...
  "dist/tests/provider-tab-boundary.test.js",
  "dist/tests/browser-authority-ledger.test.js",
  ...
  "dist/tests/council-verdict-readout.test.js",
  ...
  "dist/tests/context-selection-bounded-fairness.test.js",
