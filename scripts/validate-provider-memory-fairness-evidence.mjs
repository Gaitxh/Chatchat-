...
requireAll("Chinese Provider Memory Fairness proof", pages[0][1], ["公共记忆程序公平", "平等席位获得了可验证的同一公共记忆程序", "3/3 上一轮 actor 被代表"]);
requireAll("English Provider Memory Fairness proof", pages[1][1], ["PUBLIC MEMORY PROCEDURAL FAIRNESS", "Equal seats received a verifiably consistent public-memory procedure", "3/3 previous-round actors represented"]);

console.log("✓ Chromium proves an 18-event latest round becomes a 12-event seat-representative public deck with 3/3 actors, equal payload fingerprints and no repair drift");
