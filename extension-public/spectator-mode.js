(() => {
  ...
  function init() {
    ...
    style.textContent = `
      ...
      html[data-spectator-mode=quiet] .live-room-card,html[data-spectator-mode=quiet] .shared-board-card,html[data-spectator-mode=quiet] #relationship-summary-root,html[data-spectator-mode=quiet] #consultation-theater-root,html[data-spectator-mode=quiet] #evidence-root,html[data-spectator-mode=quiet] #source-observation-root,html[data-spectator-mode=quiet] #next-move-root,html[data-spectator-mode=quiet] #consultation-receipt-root,html[data-spectator-mode=quiet] #investigation-trail-root,html[data-spectator-mode=quiet] #consultation-history-root{display:none!important}
