(() => {
  ...
  function init() {
    ...
    style.textContent = `
      ...
      html[data-spectator-mode=quiet] .live-room-card,html[data-spectator-mode=quiet] .shared-board-card,html[data-spectator-mode=quiet] #relationship-summary-root,html[data-spectator-mode=quiet] #consultation-theater-root,html[data-spectator-mode=quiet] #evidence-root,html[data-spectator-mode=quiet] #source-observation-root{display:none!important}
