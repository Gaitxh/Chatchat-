(() => {
  ...
  style.textContent = `
    ...
    html[data-spectator-mode=quiet] .live-room-card,html[data-spectator-mode=quiet] .shared-board-card,html[data-spectator-mode=quiet] #relationship-summary-root,html[data-spectator-mode=quiet] #consultation-theater-root,html[data-spectator-mode=quiet] #evidence-root{display:none!important}
  ...
  const copy = {
    en: {
      ...
      live: "Live",
      arena: "Arena",
      quietHint: "Proposal and outcome only. The meeting still runs exactly the same.",
      liveHint: "Watch public positions and event-backed turning points.",
      arenaHint: "Full relationship battlefield, stronger motion — same consultation underneath.",
    },
    zh: {
      label: "观赛模式",
      quiet: "安静",
      live: "直播",
      arena: "竞技场",
      quietHint: "只看提案与结果。会议本身完全照常运行。",
      liveHint: "观看公开立场和由真实事件触发的关键转折。",
      arenaHint: "关系战场与动效全开——底层协商仍然完全相同。",
    },
  };
